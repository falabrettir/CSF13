...
=======
    ...
    unsigned int i_Menor = 0,j_Menor = 1; //Esta inicializa��o � necess�ria para os casos que a menor dist�ncia seja entre os ret�ngulos 0 e 1.*/
...
=======
    return (float) (a + b)/2; //O c�lculo das coordenadas do centro de um ret�ngulo � realizado somando as duas coordenadas XSE e XID ou YSE e YID
>>>>>>> Stashed changes
                        //e dividindo por 2.
}
/**---------------------------------------------------------------------------------------------------------------------------------------------*/
